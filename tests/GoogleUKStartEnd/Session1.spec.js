...
try {
    ...
    var TestData = require("../../data/TestData/" + "local" + ".GoogleUKStartEnd.data.js");
    var testData = new TestData();
    testData.load(dictData);
} catch(err) {
    console.log("WARNING: ../../data/TestData/" + "local" + ".GoogleUKStartEnd.data.js not found.");
	//console.log(err);
}
...
// -----------------------------------------------------------------------------
describe('GoogleUKStartEnd.Session1', function () {
    var iStep = 1;
...
// -----------------------------------------------------------------------------
	automation.using("running Session1 test script", require('./Session1.script.js'),
        function (step) {
			var result;
            var sParams = "";
